  ...
  return (
    <>
     <div className="max-w-[1300px] text-center justify-center mx-auto  sm:p-2 lg:p-0">
      ...
      <div className="partnerWrapper relative bg-bottom flex justify-start sm:mb-5 lg:mb-10 h-70% sm:m-h-[550px]">
        ...
        <div id="partners" className="w-[640px] sm:ml-0 lg:ml-[60px] sm:mt-10 lg:mt-32 z-50">
          ...
          <div className=" sm:mb-0 lg:mb-0 sm:p-5">
            {partnersList.map((partner, key) => {
              return (
                <>
                <div key={key} className="flex mb-8 ml-16">
                  <div className="flex items-start sm:gap-4 lg:gap-6">
                    <div className="flex-shrink-0 flex items-center justify-center sm:w-[80px] sm:h-[80px] lg:w-[190px] lg:h-[190px] rounded-[20px] bg-cardsBtns">
                      <Image className="sm:w-[50px] sm:h-[50px] lg:w-[120px] lg:h-[120px]" src={partner.avatar} alt={partner.name} />                                
                    </div>
      ...
      <div className="sm:p-2 lg:p-0">
            <ActionButton
              disabled={false}
              className={
              "actionBtn bg-thirdBtns flex justify-center mx-auto sm:w-full lg:w-[550px] sm:p-auto lg:p-0 rounded-[42px] sm:p-3 lg:p-5 sm:mt-4 lg:mt-20 text-lg font-semibold hover:shadow-[0_4px_4px_rgba(8,210,150,0.3)]"
              }
