  ...
  return (
    <>
     <div className="max-w-[1200px] text-center justify-center mx-auto  sm:p-3 lg:p-0">
      ...
      <div className="aboutWrapper relative sm:mt-0 lg:mt-[-100px] flex justify-end mb-20 h-70% sm:m-h-[550px]">
      ...
      <Image className="absolute sm:hidden lg:flex lg:left-0  lg:top-0 z-[-1]" src={SubscriptionSectionFigure} alt={""} />
        ...
        <ActionButton
          disabled={false}
          className="bg-secondaryButton flex justify-center mb-14 sm:w-full mx-auto lg:w-[550px] mx-auto sm:p-4 lg:px-10 lg:py-6 rounded-[42px] text-white font-bold sm:text-lg lg:text-xl hover:shadow-[0_8px_16px_rgba(252,21,93,0.4)] transition-all border-2 border-secondaryColor"
