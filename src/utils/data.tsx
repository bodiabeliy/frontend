...
import AboutIcon1 from "../../public/static/cart.png"
import AboutIcon2 from "../../public/static/house-check-fill.svg"
import AboutIcon3 from "../../public/static/cup-hot-fill.svg"
import AboutIcon4 from "../../public/static/Union.svg"
import AboutIcon5 from "../../public/static/taxi-front.svg"
import AboutIcon6 from "../../public/static/raphael_people.svg"
import AboutIcon7 from "../../public/static/fuel-pump-fill.svg"
import AboutIcon8 from "../../public/static/gift-fill.svg"
import AboutIcon9 from "../../public/static/gift-fill.svg"
...
import Purchages1 from "../../public/static/mockcard.png"
import Purchages2 from "../../public/static/mockcard2.png"
import Purchages3 from "../../public/static/mockcard3.png"
import Purchages4 from "../../public/static/mockcard4.png"
import Purchages5 from "../../public/static/mockcard5.png"
import Purchages6 from "../../public/static/mockcard6.png"
import Purchages7 from "../../public/static/mockcard7.png"
import Purchages8 from "../../public/static/mockcard8.png"
...
export const benefitList =[
    {
        image:Benefit1,
        position:"Акційна підписка для перших 100 000 користувачів - долучайтесь до Azamaza та отримайте всі послуги без обмежень",  },
    {
        image:Benefit2,
...
export const howitworksList =[
    ...
    {
        name:"Gracy-Chen",
        description:"Запуск прoекту - початок 2026 року. Кожен учасник отримає безлімітній доступ до всіх послуг, сервісів і пропозицій без обмежень до 1 січня 2027",
        avatar:HowItWorks2
    },
    {
        name:"Jean-Charles",
...
export const SubscribeBenefitList =[
    ...
    },
    {
        ...
        description:"ти можеш зафіксувати найвигіднішу вартість на старті — без ризиків і переплат",
    ...
    {
        name:"Підсумок",
        description:"Придбати підписку сьогодні — означає виграти більше:",
        avatar:SubscribeIcon5,
        subDescription:[
            "Більше вигоди",
            "Більше привілеїв",
            "Більше можливостей стати частиною великого проєкту з самого старту"
        ],
    }
]
